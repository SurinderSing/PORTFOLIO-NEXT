...
const ProfileSideSection: React.FC = () => {
  return (
    <FadeIn
      ...
      className="flex flex-col items-center justify-start w-full max-w-[23rem] sm:max-w-none h-[calc(100vh-10.2pc)] max-h-[650px] sm:h-auto sm:max-h-none bg-tertiary rounded-2xl shadow-sm"
    >
