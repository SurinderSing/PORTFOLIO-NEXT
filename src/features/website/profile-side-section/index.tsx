...
const ProfileSideSection: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-start w-full max-w-[23rem] sm:max-w-none h-[calc(100vh-11.85pc)] sm:h-full bg-tertiary rounded-2xl shadow-sm">
      <PhotoSection />
      <SocialMediaLinks />
      <ContactsSection />
    </div>
